...
```js
import {MDCChipSet} from '../mdc-chips';
...
To use the `MDCChip` and `MDCChipSet` classes, [import](../../docs/importing-js.md) both classes from `../mdc-chips`.
