...
```javascript
import {MDCTab, MDCTabFoundation} from '../mdc-tabs';
import {MDCTabBar, MDCTabBarFoundation} from '../mdc-tabs';
```
...
import {MDCTab, MDCTabFoundation} from '../mdc-tabs';
import {MDCTabBar, MDCTabBarFoundation} from '../mdc-tabs';
import {MDCTabBarScroller, MDCTabBarFoundationScroller} from '../mdc-tabs';
```
...
```javascript
import {MDCTabBarScroller, MDCTabBarScrollerFoundation} from '../mdc-tabs';
